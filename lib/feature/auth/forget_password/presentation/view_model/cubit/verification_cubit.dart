...
import 'package:exam_app/feature/auth/forget_password/domain/use_case/verify_reset_code_use_case.dart';
import 'package:exam_app/feature/auth/forget_password/presentation/view_model/states/verification_state.dart';
...
class VerificationCubit extends Cubit<VerificationState> {
  ...
  void resetError() {
    emit(
      state.copyWith(status: VerificationStatus.initial, errorMessage: null),
    );
  }
