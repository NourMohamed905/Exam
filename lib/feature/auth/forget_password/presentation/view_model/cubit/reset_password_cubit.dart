...
import 'package:exam_app/feature/auth/forget_password/domain/use_case/reset_password_use_case.dart';
...
class ResetPasswordCubit extends Cubit<ResetPasswordState> {
  ...
  Future<void> resetPassword(String email, String newPassword) async {
    ...
    emit(
      state.copyWith(status: ResetPasswordStatus.loading, errorMessage: null),
    );
