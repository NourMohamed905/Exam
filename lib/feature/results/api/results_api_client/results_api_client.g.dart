...
part of 'results_api_client.dart';
...
Map<String, dynamic> _$SubjectResponseToJson(SubjectResponse instance) =>
    <String, dynamic>{'message': instance.message, 'subject': instance.subject};
...
class _ResultsApiClient implements ResultsApiClient {
  _ResultsApiClient(this._dio, {this.baseUrl, this.errorLogger}) {
